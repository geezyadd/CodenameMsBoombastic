...
namespace AdvancedInspector {
    /// <summary>
    /// Hides fields in the Inspector based on a condition.
    /// </summary>
    public class HideIfAttribute : Attribute {
        ...
        public HideIfAttribute(ConditionOperation operation, object comparand, object reference) {
            Operation = operation;
            Comparand = comparand;
            Reference = reference;
        }
        ...
        /// <param name="comparand">The value to be compared. This is the object that will be used for comparison with the field.</param>
        /// <param name="reference">The reference value to be used for comparison. This serves as the target for the comparison with the field.</param>
        public HideIfAttribute(object comparand, object reference) {
        ...
        public HideIfAttribute(ConditionOperation operation, object comparand, object reference, bool hardCondition) {
            Operation = operation;
            Comparand = comparand;
            Reference = reference;
        ...
        /// <param name="reference">The reference value to be used for comparison. This serves as the target for the comparison with the field.</param>
        /// <param name="hardCondition">Disables the search for fields or methods in the class</param>
        public HideIfAttribute(object comparand, object reference, bool hardCondition) {
            Operation = ConditionOperation.Equals;
            Comparand = comparand;
            Reference = reference;
            HardCondition = hardCondition;
